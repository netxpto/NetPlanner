...
\begin{table}[H]
	...
	\begin{tabular}{| c | c |}
		...
		\hline
		\multicolumn{1}{|c|}{demand} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}l@{}}demandIndex\\ sourceNode\\ destinationNode\\ oduType\\ restorationMethod\end{tabular}} \\ \hline
		...
		demandIndex & ??? \\ \hline
		\multicolumn{1}{|c|}{demandPath} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}l@{}}demandIndex\\ pathIndex\\ linkIndex\\ Hops\end{tabular}} \\ \hline
		nextPath & ??? \\ \hline
