...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|}
		...
		Demands Ordering Criterion                                                        & ODU4...ODU0   & \begin{tabular}[c]{@{}c@{}}Order by which demands will be\\ sorted\end{tabular}                     \\ \hline
		...
		Transport Mode                                                               & Null          & \begin{tabular}[c]{@{}c@{}}Opaque, transparent or translucent\\ modes\end{tabular}                   \\ \hline
...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|}
		...
		Scheduler                                                             & \begin{tabular}[c]{@{}c@{}}ODU0, ODU1,ODU2, ODU3, ODU4,\\   Demands Odering Criterion\end{tabular}                 & None                                                                         \\ \hline
