...
\begin{table}[H]
	...
	\begin{tabular}{| c | c | c | c |}
		...
		odu0                     &                        & matrix        & \begin{tabular}[c]{@{}c@{}}ODU0 demands \\ matrix\end{tabular}                                      \\ \hline
		odu1                     &                        & matrix        & \begin{tabular}[c]{@{}c@{}}ODU1 demands \\ matrix\end{tabular}                                      \\ \hline
		odu2                     &                        & matrix        & \begin{tabular}[c]{@{}c@{}}ODU2 demands \\ matrix\end{tabular}                                      \\ \hline
		odu3                     &                        & matrix        & \begin{tabular}[c]{@{}c@{}}ODU3 demands \\ matrix\end{tabular}                                      \\ \hline
		odu4                     &                        & matrix        & \begin{tabular}[c]{@{}c@{}}ODU4 demands \\ matrix\end{tabular}                                      \\ \hline
		numberOfNodes            & 0                      & integer       & \begin{tabular}[c]{@{}c@{}}Number of network \\ nodes\end{tabular}                                  \\ \hline
		...
		physicalTopology         &                        & matrix        & \begin{tabular}[c]{@{}c@{}}Adjacency matrix of the \\ physical network\end{tabular}                 \\ \hline
		...
		opticalChannelCapacity   & 100                    & integer       & \begin{tabular}[c]{@{}c@{}}Capacity of each optical \\ channel in Gbps\end{tabular}                 \\ \hline
		numberOfPaths            & 3                      & integer       & \begin{tabular}[c]{@{}c@{}}Number of short paths created \\ between each pair of nodes\end{tabular} \\ \hline
		shortestPathType         & hops                   & string        & \begin{tabular}[c]{@{}c@{}}Shortest path type: \\ hops \\ km\end{tabular}                           \\ \hline
		lightPathCriterion       &                        &               &                                                                                                     \\ \hline
	\end{tabular}
	\caption{System Input Parameters}
	\label{system_input_parameters_opaque}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{| c | c | c | c | c |}
		\hline
%		\textbf{demandIndex} & \textbf{sourceNode} & \textbf{destinationNode} & \textbf{oduType} & \textbf{restorationMethod}\\ \hline
		\begin{tabular}[c]{@{}c@{}}\textbf{demandIndex} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{sourceNode} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{destinationNode} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{oduType} \\ (integer)\end{tabular} &\begin{tabular}[c]{@{}c@{}}\textbf{restorationMethod} \\ (integer)\end{tabular} \\ \hline
		1...D                & 1...N               & 1...N                    & 0...4            & \begin{tabular}[c]{@{}l@{}}0 - None\\ 1 - Protection 1+1\end{tabular}\\ \hline
	\end{tabular}
	\caption{Demand Structure}
	\label{demand_structure}
\end{table}

D = numberOfDemands, N = numberOfNodes\\

%\begin{table}[H]
%	\centering
%	\begin{tabular}{| c | c | c | c | c |}
%		\hline
%		\begin{tabular}[c]{@{}c@{}}\textbf{demandIndex} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{sourceNode} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{destinationNode} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{oduType} \\ (integer)\end{tabular} &\begin{tabular}[c]{@{}c@{}}\textbf{restorationMethod} \\ (integer)\end{tabular} \\ 
%		\hline
%		\begin{tabular}[c]{@{}c@{}}1\\ ...\\ numberOfDemands\end{tabular} & \begin{tabular}[c]{@{}c@{}}1\\ ...\\ numberOfNodes\end{tabular} & \begin{tabular}[c]{@{}c@{}}1\\ ...\\ numberOfNodes\end{tabular} & \begin{tabular}[c]{@{}c@{}}0\\ ...\\ 4\end{tabular} & \begin{tabular}[c]{@{}l@{}}0 - None\\ 1 - Protection 1+1\end{tabular} \\ \hline
%	\end{tabular}
%	\caption{Demand Structure}
%	\label{demand_structure}
%\end{table}
...
%	\end{tabular}
%	\caption{LogicalTopology Structure}
%	\label{logical_structure}
%\end{table}
%
%N = numberOfNodes\\
%
...
%		N             & C & C   & C   & 0\\ \hline
%	\end{tabular}
%	\caption{PhysicalTopology Structure}
%	\label{physical_structure}
%\end{table}
%
%N = numberOfNodes, C = Capacity = opticalChannels * opticalChannelCapacity\\
...
\begin{table}[H]
	...
	\begin{tabular}{| c | c | c | c |}
		\hline
		\begin{tabular}[c]{@{}c@{}}\textbf{index} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{linkSourceNode} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{linkDestinationNode} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{numberOfLightPaths} \\ (integer)\end{tabular} \\ \hline
		1                & 1...N               & 1...N                    & -1            \\ \hline
		...				 & 1...N               & 1...N                    & -1           \\ \hline
		L				 & 1...N               & 1...N                    & -1            \\ \hline	
	\end{tabular}
	\caption{Logical Link Structure}
	\label{logical_link_structure}
\end{table}

L = numberOfLogicalLinks, N = numberOfNodes \\

\begin{table}[H]
	\centering
	\begin{tabular}{| c | c | c | c | c |}
		\hline
		\begin{tabular}[c]{@{}c@{}}\textbf{linkIndex} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{linkPathNumber} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{physicalLinks} \\ ()\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{wavelength} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{capacity} \\ (integer)\end{tabular} \\ \hline
		1            & 1          & \begin{tabular}[c]{@{}c@{}}\textbf{[0/1...0/1]} \\ (1...L)\end{tabular}        &     &        \\ \hline
		...			 & ...        & \begin{tabular}[c]{@{}c@{}}\textbf{[0/1...0/1]} \\ (1...L)\end{tabular}        &     &        \\ \hline
		1		     & LP         & \begin{tabular}[c]{@{}c@{}}\textbf{[0/1...0/1]} \\ (1...L)\end{tabular}        &     &        \\ \hline
		...			 & ...        &\begin{tabular}[c]{@{}c@{}}\textbf{[0/1...0/1]} \\ (1...L)\end{tabular}         &     &        \\ \hline
		L		     & LP         & \begin{tabular}[c]{@{}c@{}}\textbf{[0/1...0/1]} \\ (1...L)\end{tabular}        &     &        \\ \hline	
	\end{tabular}
	\caption{Light Path Structure}
	\label{light_path_structure}
\end{table}

L = numberOfLogicalLinks, LP = numberOfLightPaths \\
...
\begin{table}[H]
	...
	\begin{tabular}{| c | c | c | c |}
		\hline
		\begin{tabular}[c]{@{}c@{}}\textbf{index} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{linkSourceNode} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{linkDestinationNode} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{numberOfOpticalChannels} \\ (integer)\end{tabular} \\ \hline
		1                & 1...N               & 1...N                    & OC           \\ \hline
		...				 & 1...N               & 1...N                    & OC           \\ \hline
		L				 & 1...N               & 1...N                    & OC           \\ \hline	
	\end{tabular}
	\caption{Physical Link Structure}
	\label{physical_link_structure}
\end{table}

L = numberOfPhysicalLinks, N = numberOfNodes, OC = numberOfOpticalChannels \\

\begin{table}[H]
	\centering
	\begin{tabular}{| c | c | c | c | c|  c|}
		\hline
		\begin{tabular}[c]{@{}c@{}}\textbf{linkIndex} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{opticalChannelNumber} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{capacity} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{wavelength} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{sourceNode} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{destinationNode} \\ (integer)\end{tabular}\\ \hline
		1            & 1          &        &          & 1...N         & 1...N            \\ \hline
		...			 & ...        &        &          & 1...N         & 1...N            \\ \hline
		1		     & OC         &        &          & 1...N         & 1...N            \\ \hline
		...			 & ...        &        &          & 1...N         & 1...N            \\ \hline
		L		     & OC         &        &          & 1...N         & 1...N            \\ \hline	
	\end{tabular}
	\caption{Optical Channel Structure}
	\label{optical_channel_structure}
\end{table}

L = numberOfPhysicalLinks, OC = numberOfOpticalChannels, N = numberOfNodes \\
...
%		Scheduler\_                 & \begin{tabular}[c]{@{}c@{}}odu1 \\ odu2 \\ odu3 \\ odu4 \\ demandIndex \\ numberOfDemands\end{tabular}\\ \hline
%		LogicalTopologyGenerator\_  &  																								        \\ \hline
%		PhysicalTopologyGenerator\_ & 																						                \\ \hline
%		PathGenerator\_             &  																						                \\ \hline
%		PathTester\_                &   						                                                                            \\ \hline
%		SinkRouted\_                & None																	                                \\ \hline
%		SinkBlocked\_               & None 																								    \\ \hline
%	\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{| c | c | c |}
		...
		\begin{tabular}[c]{@{}c@{}}odu1 \\ odu2 \\ odu3 \\ odu4 \\ orderingRule \\ numberOfNodes\end{tabular} & \begin{tabular}[c]{@{}c@{}}odu1 \\ odu2 \\ odu3 \\ odu4 \\ demandIndex \\ numberOfDemands\end{tabular} & SchedulerOut\\ \hline
	\end{tabular}
	\caption{Scheduler\_ Block}
	\label{scheduler_block_opaque}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{| c | c | c |}
		\hline
		\textbf{Input Parameters}                                                 & \textbf{State Variables} & \textbf{Output Signal}\\ \hline
		\begin{tabular}[c]{@{}c@{}}transportMode \\ physicalTopology  \\ numberOfNodes\end{tabular} &        & LogicalTopologyOut    \\ \hline
	\end{tabular}
	\caption{LogicalTopologyGenerator\_ Block}
	\label{logical_block_opaque}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{| c | c | c |}
		\hline
		\textbf{Input Parameters}                                                                                                    & \textbf{State Variables} & \textbf{Output Signal}\\ \hline
		\begin{tabular}[c]{@{}c@{}}physicalTopology \\ opticalChannels \\ transmissionSystems \\ opticalChannelCapacity \\ numberOfNodes\end{tabular} &                          & PhysicalTopologyOut   \\ \hline
	\end{tabular}
	\caption{PhysicalTopologyGenerator\_ Block}
	\label{physical_block_opaque}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{| c | c | c | c |}
		\hline
		\textbf{Input Parameters}                                                 & \textbf{Input Signals}                                                                     & \textbf{State Variables} & \textbf{Output Signal}         \\ \hline
		\begin{tabular}[c]{@{}c@{}}numberOfPaths \\ shortestPathType\end{tabular} & \begin{tabular}[c]{@{}c@{}}SchedulerOut \\ LogicalTopologyOut \\ RemovedPaths\end{tabular} &                          & PathGeneratorOut\\ \hline
	\end{tabular}
	\caption{PathGenerator\_ Block}
	\label{path_generator_block_opaque}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{| c | c | c | c |}
		\hline
		\textbf{Input Parameter}  & \textbf{Input Signals}                                                          & \textbf{State Variables} & \textbf{Output Signals}\\ \hline
		lightPathCriterion        & \begin{tabular}[c]{@{}c@{}}PathGeneratorOut \\ PhysicalTopologyOut\end{tabular} &                          & \begin{tabular}[c]{@{}c@{}}RemovedPaths \\ RoutedDemands \\ BlockedDemands\end{tabular}\\ \hline
	\end{tabular}
	\caption{PathTester\_ Block}
	\label{path_tester_block_opaque}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{| c |}
		...
		RoutedDemands        \\ \hline
	\end{tabular}
	\caption{SinkRouted\_ Block}
	\label{sink_routed_block_opaque}
\end{table}
