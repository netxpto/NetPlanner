...
\begin{table}[H]
	...
	\begin{tabular}{| c | c | c | c |}
		...
		adjacencyMatrix          &                        & matrix        & \begin{tabular}[c]{@{}c@{}}Adjacency matrix of the \\ physical network\end{tabular}                 \\ \hline
...
%		\textbf{demandIndex} & \textbf{sourceNode} & \textbf{destinationNode} & \textbf{oduType} & \textbf{restorationMethod}\\ \hline
		\begin{tabular}[c]{@{}c@{}}\textbf{demandIndex} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{sourceNode} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{destinationNode} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{oduType} \\ (integer)\end{tabular} &\begin{tabular}[c]{@{}c@{}}\textbf{survivabilityMethod} \\ (integer)\end{tabular} \\ \hline
		1...D                & 1...N               & 1...N                    & 0...4            & \begin{tabular}[c]{@{}l@{}}0 - None\\ 1 - Protection 1+1\end{tabular}\\ \hline
	\end{tabular}
	\caption{Demand Variable}
...
N = numberOfNodes, x = 1 => logical link, x = 0 => not logical link\\
...
\begin{table}[H]
	...
	\begin{tabular}{| c | c | c | c |}
		...
		0                & 1...N               & 1...N                    & 0...LP            \\ \hline
		...				 & 1...N               & 1...N                    & 0...LP           \\ \hline
		L-1				 & 1...N               & 1...N                    & 0...LP            \\ \hline	
	\end{tabular}
	\caption{Logical Link Variable}
	\label{logical_link_variable}
\end{table}

L = numberOfLogicalLinks, N = numberOfNodes, LP = numberOfLightPaths \\

\begin{table}[H]
	\centering
	\begin{tabular}{| c | c | c | c | c |}
		\hline
		\begin{tabular}[c]{@{}c@{}}\textbf{linkIndex} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{linkPathNumber} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{physicalLinks} \\ (vector<integer>)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{wavelength} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{capacity} \\ (integer)\end{tabular} \\ \hline
		0            & 1          & \begin{tabular}[c]{@{}c@{}}\textbf{[0/1...0/1]} \\ (1...L)\end{tabular}        &     &        \\ \hline
		...			 & ...        & \begin{tabular}[c]{@{}c@{}}\textbf{[0/1...0/1]} \\ (1...L)\end{tabular}        &     &        \\ \hline
		0		     & LP         & \begin{tabular}[c]{@{}c@{}}\textbf{[0/1...0/1]} \\ (1...L)\end{tabular}        &     &        \\ \hline
		...			 & ...        &\begin{tabular}[c]{@{}c@{}}\textbf{[0/1...0/1]} \\ (1...L)\end{tabular}         &     &        \\ \hline
		L-1		     & LP         & \begin{tabular}[c]{@{}c@{}}\textbf{[0/1...0/1]} \\ (1...L)\end{tabular}        &     &        \\ \hline	
	\end{tabular}
	\caption{Light Path Variable}
	\label{light_path_variable}
\end{table}
...
\begin{table}[H]
	...
	\end{tabular}
	\caption{Physical Link Variable}
	\label{physical_link_variable}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{| c | c | c | c |}
		\hline
		\begin{tabular}[c]{@{}c@{}}\textbf{linkIndex} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{opticalChannelNumber} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{wavelength} \\ (integer)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{capacity} \\ (integer)\end{tabular}\\ \hline
		0            & 1          &        &                   \\ \hline
		...			 & ...        &        &                   \\ \hline
		0		     & OC         &        &                   \\ \hline
		...			 & ...        &        &                   \\ \hline
	...
	\label{optical_channel_variable}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{| c | c | c |}
		...
		\begin{tabular}[c]{@{}c@{}}odu1 \\ odu2 \\ odu3 \\ odu4 \\ orderingRule\end{tabular} & \begin{tabular}[c]{@{}c@{}}odu1 \\ odu2 \\ odu3 \\ odu4 \\ demandIndex \\ numberOfDemands\end{tabular} & SchedulerOut\\ \hline
	\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{| c | c | c |}
		\hline
		\textbf{Input Parameters}                                                 & \textbf{State Variables} & \textbf{Output Signal}\\ \hline
		\begin{tabular}[c]{@{}c@{}}transportMode \\ physicalTopology\end{tabular} &        & LogicalTopologyOut    \\ \hline
	\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{| c | c | c |}
		\hline
		\textbf{Input Parameters}                                                                                                    & \textbf{State Variables} & \textbf{Output Signal}\\ \hline
		\begin{tabular}[c]{@{}c@{}}physicalTopology \\ opticalChannels \\ transmissionSystems \\ opticalChannelCapacity\end{tabular} &                          & PhysicalTopologyOut   \\ \hline
	\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{| c | c | c | c | c |}
		...
		0...D-1                & 1...N               & 1...N                    & 0...4            & \begin{tabular}[c]{@{}l@{}}0 - None\\ 1 - Protection 1+1\end{tabular}\\ \hline
	\end{tabular}
	\caption{Demand Variable}
	\label{demand_variable}
\end{table}
...
Logical Matrix NxN plus lightPaths Matrix LPx5
...
\begin{table}[H]
	...
	\begin{tabular}{| c | c | c | c | c |}
		...
		\textbf{lightPathIndex} & \textbf{sourceNode} & \textbf{destinationNode} & \textbf{Capacity (ODU0)} & \textbf{ochsIndexes} \\ \hline
		  0                      & 1...N                    & 1...N                &  1...OC    & 0...Och-1       \\ \hline 
		  ...					 & 1...N					& 1...N				   &  1...OC	& 0...Och-1	      \\ \hline
		  LP-1                   & 1...N                    & 1...N                &  1...OC    & 0...Och-1       \\ \hline       	
	\end{tabular}
	\caption{Light paths}
	\label{lps}
\end{table}

LP - numberOfLightPaths, N = numberOfNodes, OC = opticalChannelCapacity, Och - numberOfOpticalChannels \\
